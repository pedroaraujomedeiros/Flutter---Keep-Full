...
class GroceryItem extends StatefulWidget {
  ...
  final ActionGroceryItem actionGroceryItem;
  ...
  GroceryItem(this.grocery, this.actionGroceryItem);

  /// property isNewGrocery
  bool get isNewGrocery{
    return actionGroceryItem == ActionGroceryItem.Add;
  }
...
class _GroceryItemState extends State<GroceryItem> {
  ...
  void _submitData() {
    ...
    */
    ...
    if(widget.actionGroceryItem == ActionGroceryItem.Add){
      BlocProvider.of<GroceryListBloc>(context).add(ItemAdded(grocery: widget.grocery));
    }
    else{
      BlocProvider.of<GroceryListBloc>(context).add(ItemEdited(grocery: widget.grocery));
    }
